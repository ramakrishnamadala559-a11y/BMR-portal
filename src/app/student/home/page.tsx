        ...
        <div className="flex flex-wrap items-center gap-2.5 z-10">
          {!user && (
            <button
              ...
              className="bg-slate-955 hover:bg-slate-900 px-3.5 py-2 border border-slate-800 rounded-xl text-[10px] text-violet-400 font-bold uppercase tracking-wider shadow-sm cursor-pointer transition-all"
            >
              ← Change Student
            </button>
          )}
