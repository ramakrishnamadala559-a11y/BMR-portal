  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 animate-slide-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {inactiveStudents.length > 0 && step === 1 && (
          <button
            type="button"
            onClick={() => setShowBookings(!showBookings)}
            className="self-start sm:self-center inline-flex items-center gap-1.5 px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-xs font-bold uppercase tracking-wider text-white rounded-xl shadow-lg shadow-blue-600/10 hover:shadow-blue-500/20 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
